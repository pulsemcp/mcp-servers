...
| [dynamodb](./experimental/dynamodb/)                     | AWS DynamoDB table and item operations with fine-grained access    | 0.1.0        | Not Started   | Developers using AWS DynamoDB                               | Requires AWS credentials; Fine-grained tool access control                                        |
