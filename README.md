...
| [ssh](./experimental/ssh/)                               | SSH remote server management with agent authentication             | 0.1.1        | Not Started   | Developers needing SSH access to remote servers            | Supports SSH agent for passphrase-protected keys                                            |
