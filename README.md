...
| [playwright-stealth](./experimental/playwright-stealth/) | Browser automation with Playwright and optional stealth mode       | 0.0.6        | Not Started   | Developers needing browser automation with anti-bot bypass  | Optional stealth mode via STEALTH_MODE env var                                              |
