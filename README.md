...
| Name                                                     | Description                                                        | Local Status | Remote Status | Target Audience                                             | Notes                                                                                       |
| -------------------------------------------------------- | ------------------------------------------------------------------ | ------------ | ------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [agent-orchestrator](./experimental/agent-orchestrator/) | Agent parallelization system for agentic coding and ops            | 0.2.0        | Not Started   | PulseMCP team for agent orchestration                       | Requires AGENT_ORCHESTRATOR_BASE_URL and API_KEY; Internal use only                         |
...
| [proctor](./experimental/proctor/)                       | Proctor exam runner for testing MCP servers                        | 0.1.0        | Not Started   | PulseMCP team for MCP server testing                        | Requires PROCTOR_API_KEY; Internal use only                                                 |
| [pulsemcp-cms-admin](./experimental/pulsemcp-cms-admin/) | Internal API for managing PulseMCP newsletter content              | 0.6.0        | Not Started   | PulseMCP team for content management                        | Requires PULSEMCP_ADMIN_API_KEY; Internal use only                                          |
