...
| [file-upload](./experimental/file-upload/)               | Remote filesystem operations on cloud storage (GCS)                | 0.1.0        | Not Started   | Developers needing cloud storage integration               | Requires GCS credentials; Full CRUD operations; Published as `remote-filesystem-mcp-server` |
...
| [good-eggs](./experimental/good-eggs/)                   | Good Eggs grocery shopping automation                              | 0.1.0        | Not Started   | Users of Good Eggs grocery delivery service                | Requires Good Eggs username and password; NOT officially affiliated with Good Eggs          |
| [onepassword](./experimental/onepassword/)               | 1Password credential and secrets management via CLI                | 0.1.0        | Not Started   | Developers using 1Password for secrets management          | Requires 1Password CLI and service account token; NOT officially affiliated with 1Password  |
...
| [playwright-stealth](./experimental/playwright-stealth/) | Browser automation with Playwright and optional stealth mode       | 0.0.4        | Not Started   | Developers needing browser automation with anti-bot bypass | Optional stealth mode via STEALTH_MODE env var                                              |
...
| [ssh](./experimental/ssh/)                               | SSH remote server management with agent authentication             | 0.1.0        | Not Started   | Developers needing SSH access to remote servers            | Supports SSH agent for passphrase-protected keys                                            |
