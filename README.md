...
| Name                                                     | Description                                                        | Local Status      | Remote Status | Target Audience                                       | Notes                                                                |
| -------------------------------------------------------- | ------------------------------------------------------------------ | ----------------- | ------------- | ----------------------------------------------------- | -------------------------------------------------------------------- |
| [agent-orchestrator](./experimental/agent-orchestrator/) | Agent parallelization system for agentic coding and ops            | Not Yet Published | Not Started   | PulseMCP team for agent orchestration                 | Requires AGENT_ORCHESTRATOR_BASE_URL and API_KEY; Internal use only  |
...
| [pulsemcp-cms-admin](./experimental/pulsemcp-cms-admin/) | Internal API for managing PulseMCP newsletter content              | 0.3.2             | Not Started   | PulseMCP team for content management                  | Requires PULSEMCP_ADMIN_API_KEY; Internal use only                   |
