...
| [file-upload](./experimental/file-upload/)               | Upload files to cloud storage (GCS)                                | 0.1.0        | Not Started   | Developers needing to upload files to cloud storage        | Requires GCS credentials; Works with file:// URIs from other MCP servers                    |
