...
| [gmail](./experimental/gmail/)                           | Gmail Workspace integration for email access                       | 0.0.2        | Not Started   | Google Workspace organizations needing Gmail integration   | Requires service account with domain-wide delegation; NOT officially affiliated with Google |
