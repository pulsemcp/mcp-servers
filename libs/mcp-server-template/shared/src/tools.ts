...
/**
 * Available tool groups. Add your own groups here.
 * Common patterns:
 * - 'readonly' vs 'write' vs 'admin' for permission levels
 * - Feature-specific groups like 'search', 'analytics', 'management'
 */
...
const ALL_TOOLS: ToolDefinition[] = [
  // Example tool - available in all groups
  { factory: exampleTool, groups: ['readonly', 'write', 'admin'] },
  // Search tool - read-only operation
  { factory: searchTool, groups: ['readonly', 'write', 'admin'] },
  // Add more tools here:
  // { factory: createItemTool, groups: ['write', 'admin'] },
  // { factory: deleteItemTool, groups: ['admin'] },
];
