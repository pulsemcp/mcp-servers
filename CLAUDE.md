...
- **Test File Patterns**: When simplifying manual tests to follow vitest patterns (like pulse-fetch), test the tool functions directly rather than using TestMCPClient, and ensure vitest config includes the correct test file patterns
