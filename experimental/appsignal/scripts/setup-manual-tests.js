...
if (!existsSync(envPath)) {
  ...
  console.log('   Then edit .env and add your APPSIGNAL_API_KEY');
  process.exit(1);
}

// Check if API key is set
const envContent = readFileSync(envPath, 'utf8');
if (!envContent.includes('APPSIGNAL_API_KEY=') || envContent.includes('APPSIGNAL_API_KEY=your-')) {
  console.error('❌ APPSIGNAL_API_KEY not configured in .env!');
