...
- `prepare_claim_to_submit` tool for claim form validation with confirmation token pattern
- `submit_claim` tool for actual claim submission after user confirmation
