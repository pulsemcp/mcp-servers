...
installProcess.on('close', (code) => {
  ...
  buildProcess.on('close', (buildCode) => {
    ...
    console.log('\nTo run manual tests:');
    console.log('  1. Create a .env file with your Aetna credentials:');
    console.log('     AETNA_USERNAME=your-username');
    console.log('     AETNA_PASSWORD=your-password');
    console.log('     EMAIL_IMAP_USER=your-email@gmail.com');
    console.log('     EMAIL_IMAP_PASSWORD=your-app-password');
