...
The Rails application now supports JSON responses for posts operations. However, authors, MCP servers, and MCP clients endpoints are not yet available via the admin API.
