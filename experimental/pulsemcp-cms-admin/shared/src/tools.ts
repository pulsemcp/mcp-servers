...
import { getGoodJobStatistics } from './tools/get-good-job-statistics.js';
...
const ALL_TOOLS: ToolDefinition[] = [
  ...
  { factory: getGoodJobStatistics, group: 'good_jobs', isWriteOperation: false },
 ...
 * - good_jobs_readonly: GoodJob background job tools (read only)
 *
