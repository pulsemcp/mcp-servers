...
/**
 * Rails API response structure for implementations.
 * This is the raw shape returned by the Rails backend.
 */
export interface RailsImplementation {
  id: number;
  name: string;
...
/**
 * Rails API response structure for implementations search endpoint.
 */
export interface RailsSearchResponse {
 ...
 */
export function mapToUnifiedServer(impl: RailsImplementation): UnifiedMCPServer | null {
