...
export interface CreateSupervisorPostInput {
  title: string;
  slug: string;
...
export async function createSupervisorPost(
  apiKey: string,
  baseUrl: string,
  input: CreateSupervisorPostInput
): Promise<Post> {
