  ...
  const optional: { name: string; description: string; defaultValue?: string }[] = [
    {
      name: 'TOOL_GROUPS',
      description:
        'Comma-separated list of tool groups to enable (sessions,sessions_readonly,notifications,notifications_readonly,triggers,triggers_readonly,health,health_readonly,self_session)',
