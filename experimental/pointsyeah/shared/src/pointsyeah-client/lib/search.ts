 ...
 *
 * The PointsYeah website encrypts search parameters client-side before sending
 * them to api2.pointsyeah.com. Rather than reverse-engineering the encryption,
 * we let the website handle it by navigating a real browser to the search URL
 * and intercepting the create_task response.
 */
