 ...
 *
 * All logging functions write to stderr. stdout is reserved exclusively for
 * the MCP JSON-RPC protocol — using console.log here would corrupt the wire
 * format and break the server.
 */
