...
import { getMeetingTool } from './tools/get-meeting.js';
...
const ALL_TOOLS: ToolDefinition[] = [
  { factory: listMeetingsTool, groups: ['readonly', 'write', 'admin'] },
  { factory: getMeetingTool, groups: ['readonly', 'write', 'admin'] },
  { factory: listRecordingsTool, groups: ['readonly', 'write', 'admin'] },
];
